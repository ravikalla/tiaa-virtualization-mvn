package org.tiaa.virtualization.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.tiaa.virtualization.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.tiaa.virtualization.repository.UserRepository.USERS_BY_EMAIL_CACHE);
